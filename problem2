...
struct DynArray {
    ...
    int size;       // jumlah elemen yang digunakan
...
int main() {
    ...
    printDynArr(arr);
    // [10, 20, 25, 30, 40, 50] (size=6, cap=8)
    ...
    printDynArr(arr);
    // [20, 25, 30, 40, 50] (size=5, cap=8)


    // 4. getAt
    cout << "Element at index 2: " << getAt(arr, 2) << endl;
